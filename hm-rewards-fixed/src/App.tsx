...
export default function App() {
    ...
    const fetchCustomer = async () => {
      ...
      if (customerSnap.exists()) {
        ...
        if (data.claimStartTime) {
          const diff =
            86400 - Math.floor((Date.now() - data.claimStartTime) / 1000);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const updatedStamps = Math.min(currentStamps + 1, 4);

      // UNLOCK

      const unlocked = updatedStamps >= 4;
    ...
    <>
      ...
      <div className="app">
        ...
        <header className="header">
          ...
          <div className="rewardCount">🎁 {stamps}/4</div>
        </header>
        ...
        <section className="hero">
          ...
          <h2>Hygiene Matic Rewards Hub</h2>

          <p>
            Scan your combo pack, enter your unique product code and collect
            reward stamps on every purchase. Buy 4, get 1 free!
          </p>
        </section>
          ...
          <div className="stepsContainer">
            ...
            <div className="stepCard">
              ...
              <p>
                ...
                purchase. Collect 4 stamps to get 1 free reward.
              </p>
            </div>
          </div>
        </section>
